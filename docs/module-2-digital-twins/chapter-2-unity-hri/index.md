---
title: Chapter 2 - Digital Twin and HRI in Unity
sidebar_position: 2
description: Creating digital twins in Unity with human-robot interaction
keywords: [unity, digital twin, hri, robotics, simulation]
learning_objectives:
